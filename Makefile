...
build:
	mkdir -p build
	daedalus build --minify --onefile --sourcemap --htmlname maze.html     --paths=./src --static src/maze/resource src/maze/app.js ./build
	...
	daedalus build --minify --onefile --sourcemap --htmlname axedemo.html  --paths="./src:./src/axertc"  src/axedemo/client_entry.js ./build
